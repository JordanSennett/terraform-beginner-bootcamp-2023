...
- [Terraform Beginner Bootcamp 2023 - Week 0](#terraform-beginner-bootcamp-2023---week-0)
  ...
  * [Install the Terraform CLI](#install-the-terraform-cli)
    ...
    + [Consoderationss for Linux Distubitions](#consoderationss-for-linux-distubitions)
    + [Refactoring into Bash scripts](#refactoring-into-bash-scripts)
      - [Shebang](#shebang)
      - [Execution Considerations](#execution-considerations)
    + [Linux Permissions Considerations](#linux-permissions-considerations)
    + [Github Lifecylcle (Before, Init, Command)](#github-lifecylcle--before--init--command-)
    + [Working with Env Vars](#working-with-env-vars)
      - [Setting and Unsetting ENV Vars](#setting-and-unsetting-env-vars)
  * [Printing Env Vars](#printing-env-vars)
      - [Scoping of Env Vars](#scoping-of-env-vars)
      - [Persisting ENv Vars in Gitpod](#persisting-env-vars-in-gitpod)
    + [AWS CLI is installation](#aws-cli-is-installation)
  ...
  * [Issues with Terracloud and gitpod workspace](#issues-with-terracloud-and-gitpod-workspace)
